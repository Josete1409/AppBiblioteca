...
public class ActivityListaEditorial extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_editorial);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btnInicio:
                ...
                Intent intentInicio = new Intent(ActivityListaEditorial.this, MainActivity.class);
                startActivity(intentInicio);

                break;
            case R.id.btnVolver:

                Intent intentVolver = new Intent(ActivityListaEditorial.this, ActivityOpcionesListados.class);
