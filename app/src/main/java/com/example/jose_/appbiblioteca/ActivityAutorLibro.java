...
public class ActivityAutorLibro extends AppCompatActivity implements View.OnClickListener {

    Button btnListar, btnVolver;
    ListView listAutor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_autor_libro);
